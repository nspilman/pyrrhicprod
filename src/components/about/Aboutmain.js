...
class Aboutmain extends Component{
    ...
    render(){
        return(
            ...
            <div className = "row">
            <div className = "col-sm-6 border border-light text-center text-light">
            <h1 className = "py-3">
                What We Do
            </h1>
            <img className = "img-fluid pb-3 border border-light" src = {Clock}></img>
            <p className = "pt-2">
            ...
            <img className = "img-fluid pb-3 border border-light" src = {Alex}></img>
            <p className = "pt-2">
            Alex Gurevich is the Papacito Del Arte and head of Pyrrhic Productions. 
            </p>

            <h4>Reach out at <i>Pyrrhicfilmproductions@gmail.com</i></h4>
            </div>
            </div>
            </div>
        )
